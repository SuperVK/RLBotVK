import { FieldInfo, GameInfo, BaseAgent, GameTickPacket, BallPrediction, Slice, Player, Ball as _Ball } from "rlbotjs";
...
class Car {
    ...
    constructor(car: Player) {
        ...
        this.hasWheelContact = car.hasWheelContact;
    }
}
...
export class Ball {
    ...
    gameSeconds?: number;
    constructor(ball: _Ball|Slice|any, myCar?: Car) {
        //console.log(ball)
